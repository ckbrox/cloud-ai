...
def spell_word_from_person(word: str, source_image: str, source_image_mime_type: str='image/png'):

    with open(source_image, 'rb') as f:
        image_part = types.Part.from_bytes(data=f.read(), mime_type=source_image_mime_type)
